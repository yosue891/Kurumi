...
const defaultMenu = {
  before: `“🎳¡Hola! *%name*, aqui esta mi menu de juegos"
...
let img = 'https://files.catbox.moe/ojsmx7.jpeg'
...
handler.help = ['juegosrem (para ver mis juegos)']
handler.tags = ['crow']
handler.command = ['juegosrem', 'menujuegos', 'menujuego']
