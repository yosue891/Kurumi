// ♥ 𝙼𝚎𝚗𝚞 𝚍𝚎 𝚂𝚘𝚢𝙼𝚊𝚢𝚌𝚘𝚕  yosue y wirk♥
...
> Hecho con amor por: *_maycol yosue y wirk_* (⁠◍⁠•⁠ᴗ⁠•⁠◍⁠)⁠❤
...
╰─━━━━━━━━━━━━━━━━╯`
  ...
  // Mensaje previo cute
  await conn.reply(m.chat, '⌜ ⊹ 💙Espera tantito, estamos enviando su menu❤️... ⊹ ⌟', m, {
    contextInfo: {
      externalAdReply: {
        title: botname,
        body: "Un amor que nunca se acaba Jeje <3",
        thumbnailUrl: 'https://qu.ax/KTrPV.jpg',
        sourceUrl: redes,
        mediaType: 1,
  ...
  await conn.sendMessage(m.chat, {
    video: { url: 'https://qu.ax/AucJC.mp4', gifPlayback: true },
    caption: menuText,
    gifPlayback: true,
    contextInfo: {
