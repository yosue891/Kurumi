...
let handler = async (m, { conn, isROwner, text }) => {
    ...
    if (conn.user.jid === conn.user.jid) {
        const progreso = [
      "*♻️iniciando proceso de reinicio de HinataBot*",
            "□□□□□ 0%",
            "■□□□□ 20%",
            "■■□□□ 40%",
            "■■■□□ 60%",
        ...
        await conn.sendMessage(m.chat, { text: "『✅』𝐑𝐞𝐦-𝐛𝐨𝐭 reiniciado con éxito espera unos segundos asta que el proceso termine.", edit: key });
