...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Rem-bot', 'Edge', '20.0.04'] : methodCodeQR ? ['Rem-bot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
console.log('👑 Rem-bot no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(`🌹 Rem-bot conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🥀 Error al iniciar Rem-bot: `, error))
}
})();
